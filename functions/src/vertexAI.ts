...
## まず分析する（出力はしない）
- 表記ゆれの統一: 略称・英語/カタカナ表記・愛称の違いは「同じ回答」とみなす（例:「rex」と「ティラノサウルス」は同一、「マック」と「マクドナルド」は同一）
- クラスタ: 実質同じ回答をした人のかたまり
- 外れ値: 1人だけ違う回答をした人
- 惜しい不一致: 意味は近いが微妙に違うペア
...
- 各提案の狙いと優先度:
  ...
  - 4: 寄せの読み合い（誰が言いそうと思って選んだか）/ 惜しい不一致のペア
...
## 出力例（形式と踏み込み方の参考。内容はコピーしない）
[
  {"type":"comparison","message":"かおるさんは『ティラノサウルス』、さふぁりさんは『rex』——実は同じ恐竜ですね。狙って寄せました？","priority":4,"category":"interesting"},
  {"type":"individual","target":"るんるん","message":"るんるんさんだけ『ステゴサウルス』でしたね。恐竜といえばコレ、という思い入れがあります？","priority":5,"category":"unique"},
  {"type":"group","message":"強そうな肉食が多い中で草食恐竜を選んだ人もいました。選ぶとき何を基準にしました？","priority":3,"category":"follow_up"}
]
